...
public class Playground {
    ...
    public Playground (String pathName){
        try{
            final Image imageTree = ImageIO.read(new File("./img/tree3.jpeg"));
            final Image imageGrass = ImageIO.read(new File("./img/grass3.jpeg"));
            final Image imageRock = ImageIO.read(new File("./img/rock2.jpeg"));
